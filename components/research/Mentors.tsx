          ...
          >
            ...
            <div className="flex items-center justify-between mt-8 md:mt-12">
              <button
                ...
                className="group flex items-center gap-2 px-6 py-3 text-base font-medium text-gray-600 hover:text-[#478af6] transition-colors rounded-full border border-gray-200 hover:border-[#478af6]/20 hover:bg-[#478af6]/5"
              >
                <ChevronLeft className="w-6 h-6 transition-transform group-hover:-translate-x-1" />
                <span className="hidden md:inline">Previous</span>
              </button>
              
              <CarouselProgress current={current} total={mentors.length} />
